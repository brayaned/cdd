...
@Entity
@Table(
    name = "CDDLAFT_PERFIL_RIESGO_GRUPOS_AUDITORIA",
    schema = "CDDLAFT"
)
public class PerfilRiesgoGruposAuditoriaEntity {

    @Id
    @Column(name = "ID_CONSECUTIVO_GRUPOS_AUDITORIA", nullable = false)
    ...
    public PerfilRiesgoGruposAuditoriaEntity() {
    }
