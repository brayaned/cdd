...
public class ResultadoRiesgoDTO {
    ...
    public void setDocumento(Double documento) { this.documento = documento; }
    ...
    public String getResultadoRiesgo() { return resultadoRiesgo; }
    public void setResultadoRiesgo(String resultadoRiesgo) { this.resultadoRiesgo = resultadoRiesgo; }
